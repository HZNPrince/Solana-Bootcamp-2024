...
describe("swap", async () => {
  ...
  const provider = anchorPkg.AnchorProvider.env()
  ...
  const program = anchorPkg.workspace.Swap as AnchorProgram<Swap>
  ...
  let alice: anchorPkg.web3.Keypair
  let bob: anchorPkg.web3.Keypair
  let tokenMintA: anchorPkg.web3.Keypair
  let tokenMintB: anchorPkg.web3.Keypair
